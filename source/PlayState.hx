				...
				case 'normalbg':
					{
						defaultCamZoom = 0.78;
						curStage = 'normalbg';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('daytimeback'));
						bg.antialiasing = true;
			...
			case 'game-over':
				switch (curBeat){
					...
					case 143:
	                    ...
	                    dad = new Character(10, 100, 'hologram');
	                    add(dad);
					case 145:
						mugendrip = 0.02;
						defaultCamZoom = 0.68;
						remove(boyfriend);
						boyfriend = new Boyfriend(800, 450, 'bf');
						add(boyfriend);
							...
							boyfriend.addOffset("smile", 77, 15);
					...
					case 508:
						defaultCamZoom = 0.8;
					case 512:
						FlxG.camera.flash(FlxColor.BLACK, 400);	
		        }
				case 'Beatbot':
					switch (curBeat){
					case 35:
